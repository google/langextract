"""Schema implementation for matrixai provider."""

import langextract as lx
from langextract.core.schema import BaseSchema

class matrixaiSchema(BaseSchema):
    """Schema implementation for matrixai structured output."""
    ...
    def from_examples(cls, examples_data, attribute_suffix="_attributes"):
        ...
        Returns:
            A configured matrixaiSchema instance.
        """
        extraction_types = {}
